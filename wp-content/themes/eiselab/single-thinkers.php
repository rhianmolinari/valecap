			...
			<?php //while (have_posts()) : the_post(); ?>
				...
				<header class="clearfix">
					...
					<ul id="contactThinker">
						<li id="thinkerEmail">
							<a href="mailto:<?php the_('email');?>" title="Mande um email para <?php the_title(); ?>">
								<img src="<?php bloginfo("template_url"); ?>/images/email.jpg">
							</a>
						</li>
						<li id="thinkerSocial">
							<a href="http://<?php the_('linkedin_url');?>" target="_blank" title="Linkedin de <?php the_title();?>">
								<img src="<?php bloginfo('template_url')?>/images/icon-linkedin-mini.png" alt="Linkedin" />
							</a>
							<a href="http://<?php the_('twitter_url');?>" target="_blank" title="Twitter de <?php the_title();?>">
								<img src="<?php bloginfo('template_url')?>/images/icon-twitter-mini.png" alt="Twitter" />
							</a>
							<a href="http://<?php the_('facebook_url');?>" target="_blank" title="Facebook de <?php the_title();?>">
				...
				<ul id="rate">
					<li class="parent">
						<ul>
							<li class="rateTitle">Meu top 3 Filmes</li>
					...
					<li class="parent">
						<ul>
							<li class="rateTitle">Meu top 3 Livros</li>
				...
				<ul id="highlights">
					<li class="highTitle">Pontos altos em minha trajetória</li>
				...
				<span class="clear"></span>
				<div id="other">
					<h2>Por que é possivel mudar o mundo?</h2>
					<p>
						<?php the_('justification'); ?>
					</p>
					<h2>Minha história profissional</h2>
					<p>
						<?php the_('experience'); ?>
					</p>
