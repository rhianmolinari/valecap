...
<section class="boxContent">
	<section class="boxLeft">
		...
		<section class="boxBlog">
			<h1><a href="<?php echo site_url('/blog/') ?>" title="Veja todos os posts do blog">Blog</a></h1>
			<ul id="blog">
				...
				<?php if (have_posts()) : ?>
					...
					<li>
						<a href="<?php the_permalink(); ?>">
							...
							<span>
								<span class="arrowRight"></span>Ler mais
							</span>
						</a>
					</li>
					<?php endwhile; ?>
	...
	<section class="boxRight">
		<a href="<?php bloginfo('url'); ?>/campfires" id="campfire_go">
			...
			<span>Conheça as nossas atividades de campfire</span>
		</a>
