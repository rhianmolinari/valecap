...
<article class="grid_8">
	...
	<section class="entry-content">
		...
		<div class="recommended">
			<strong>Pneus recomendados</strong>
...
<section class="grid_4 product">
	...
	<div class="box">
		...
		<ul class="aplications">
			<li><strong>Aplicações</strong><?php if(get_post_meta(get_the_ID(), 'prd_radio_ind', true) && get_post_meta(get_the_ID(), 'prd_radio_ind', true) != 'naoaplicavel_ind'): ?>
			</li>
			<li>
